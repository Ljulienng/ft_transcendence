<template>
  <div class="input-group align-items-center justify-content-between">
    ...
    <div v-if="channelMember.admin">
      ...
      <form v-on:submit.prevent="changeChannelName">
        <div
          ...
          id="channameModal"
          tabindex="-1"
          aria-labelledby="channameModal"
          aria-hidden="true"
        >
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="channameModal">
                  Change channel name
                </h5>
                <button
                  type="button"
    ...
    <div v-if="channelMember.owner">
      ...
      <form
        v-if="type == 'public'"
        v-on:submit.prevent="addPasswordToPublicChannel"
      >
        <div
          class="modal fade"
          id="addpwdModal"
          tabindex="-1"
          aria-labelledby="addpwdModal"
          aria-hidden="true"
        >
          <div class="modal-dialog">
            <div class="modal-content">
    ...
    <div v-if="channelMember.admin">
      <!-- INVITE -->
      <button
        v-if="channelMember.admin && type == 'private'"
        type="button"
        data-bs-toggle="modal"
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <template v-if="channelMember.owner">
                      ...
                      >
                        <span class="material-icons" style="color: #fff774"
                          >star</span
                        >
                      </button>
                    </template>
                  ...
                  <div class="col">
                    <template v-if="channelMember.admin">
                      ...
                      <button
                        @click="kickMember(member.user.username)"
                        v-if="
                          member.admin && !member.owner && channelMember.owner
                        "
                      >
